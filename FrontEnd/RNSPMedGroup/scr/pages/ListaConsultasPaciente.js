...
class ListaConsultasPaciente extends Component {
    ...
    FiltraConsultas() {
        ...
        if (this.state.nome !== null && this.state.nome !== "") {
            listaFiltrada = listaFiltrada.filter(x => x.nomeMedico.toLowerCase().includes(this.state.nome.toLowerCase())
            );
        }

        if (this.state.status !== null && this.state.status !== "") {
            listaFiltrada = listaFiltrada.filter(x =>
                x.statusConsulta.includes(this.state.status)
            );
        }
...
export default ListaConsultasPaciente;